...
let posOutM = [[-40,15, 200] , [150, 90, 165] , [-60, 90, 230], [140, -50, 250],]; // x, y, scale-px

let posFocusW = [[16, 20, 550] , [16, 20, 550] , [16, 20, 550], [16, 20, 550]]; // x, y, scale-px
let posFocusM = [[15, 11, 290] , [15, 11, 290] , [15, 11, 290], [15, 11, 290]]; // x, y, scale-px

let textPosW = [[60, 40, 430] , [60, 40, 430] , [60, 40, 430], [60, 40, 430]]; // x, y, w&h-px
let textPosM = [[4.5, 54, 400] , [4.5, 54, 400] , [4.5, 54, 400], [4.5, 54, 400]]; // x, y, w&h-px
